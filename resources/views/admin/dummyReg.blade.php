    ...
    <div class="row">
      <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
        <div class="card card-primary">
          ...
          <div class="card-body">
            <form method="POST" action="/registerPostDummy" class="needs-validation" novalidate="">
                {{csrf_field()}}
              
                <div class="form-group">
                    <label for="email">Names</label>
                    <input id="name" type="text" value="{{ old('names')}}" class="form-control" name="names" tabindex="1"  autofocus>
